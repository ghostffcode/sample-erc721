...
contract StarNotary is ERC721 {
    ...
    // mapping of tokenId and Owner address
    mapping(uint256 => address) public starsForExchange;
    ...
    function putStarUpForExchange(uint256 _tokenId) public {
        require(
            ownerOf(_tokenId) == msg.sender,
            "You can't exchange a star you don't own"
        );
        starsForExchange[_tokenId] = msg.sender;
    }
